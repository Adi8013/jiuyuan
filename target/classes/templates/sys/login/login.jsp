...
<%@include file="/templates/base/base.jsp"%>
<html lang="zh-CN">
<head>
<meta charset="utf-8">
...
<li style="font-size: 48px">宿舍管理系统</li>
...
<a href="http://wpa.qq.com/msgrd?v=3&uin=659282955&site=qq&menu=yes" target="_blank">关于我们@qq659282955 &nbsp &nbsp|&nbsp &nbsp</a>
 

<a>Copyright © 2018 e享软件  保留所有权利    粤ICP备120号</a>
</div>
<div id="cloud"></div>
